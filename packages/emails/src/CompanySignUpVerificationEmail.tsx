...
export interface CompanySignUpVerificationEmailProps {
   name: string;
   appName: string;
   confirmationUrl: string;
}

const CompanySignUpVerificationEmail = ({
                                           confirmationUrl,
                                           name,
                                           appName,
                                        }: CompanySignUpVerificationEmailProps) => {
   return (
      <Html lang="en">
         <Tailwind
            config={{
...
export default CompanySignUpVerificationEmail;