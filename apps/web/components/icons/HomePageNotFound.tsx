...
export interface HomePageNotFoundProps extends ComponentProps<"svg"> {
}

const HomePageNotFound = ({ ...props }: HomePageNotFoundProps) => {
   return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" {...props}>
         ...
         <g id="freepik--Planets--inject-20">
            <g style={{ opacity: "0.30000000000000004" }}>
               <path
                  d="M201,145.62a1.87,1.87,0,1,1-1.86-1.87A1.86,1.86,0,0,1,201,145.62Z"
                  style={{ fill: "#51D495" }}
               />
               <circle cx="72.97" cy="216.13" r="1.32" style={{ fill: "#51D495" }} />
               <circle cx="291.05" cy="408.33" r="1.89" style={{ fill: "#51D495" }} />
               <circle cx="336.5" cy={332} r="1.32" style={{ fill: "#51D495" }} />
               <path
               ...
               <path
                  ...
                  style={{ fill: "#51D495" }}
               />
               <circle cx="277.7" cy="136.94" r="1.32" style={{ fill: "#51D495" }} />
            </g>
            <circle cx="141.23" cy="116.36" r="21.91" style={{ fill: "#51D495" }} />
            <circle
               cx="141.23"
               cy="116.36"
               r="21.91"
         ...
         <g id="freepik--Astronaut--inject-20">
            <path
            ...
            <path
               ...
               style={{ fill: "#51D495", opacity: "0.30000000000000004" }}
            />
            <path
            ...
            <path
               ...
               style={{ fill: "#51D495", opacity: "0.6000000000000001" }}
            />
            <path
            ...
            <polygon
               ...
               style={{ fill: "#51D495", opacity: "0.5" }}
            />
         </g>
         <g id="freepik--Rocket--inject-20">
            <path
            ...
            <circle cx="222.2" cy="282.18" r="8.29" style={{ fill: "#51D495" }} />
            <polygon
